...
export const metadata = {
  ...
  description: "Terms of service and dining conditions.",
};

export default async function MenuTermsPage() {
  const page = await db.platformContent.findUnique({
    where: { slug: "terms" },
  });

  const title = page?.title || "Terms of Service";
  const content = page?.content || "Terms of service are currently being updated.";
